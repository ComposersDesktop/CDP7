...
//TW NEW
	...
	case(DRUNKWALK):
		...
		break;
	case(SIMPLE_TEX):  return set_param_data(ap,TEX_NOTEDATA			  ,26,12,"dDDDIIDDDDDD00000000000000");		
...
//TW NEW
	...
	case(RRRR_EXTEND):
		switch(mode) {
		case(0):			return set_param_data(ap,0					  ,12,8, "dddidiDD0000");
		case(1):			return set_param_data(ap,0					  ,12,12,"dddidiDDiddd");
		case(2):			return set_param_data(ap,0					  ,12,4, "dd0id0000000");
		}
		break;
...
//TW NEW
	...
	case(RRRR_EXTEND):
		switch(mode) {
		case(0):		   return set_vflgs(ap,""    ,0,""      ,"x"      ,1,0,"0"	   );
		case(1):		   return set_vflgs(ap,""    ,0,""      ,"se"     ,2,0,"00"	   );
		case(2):		   return set_vflgs(ap,""    ,0,""      ,""       ,0,0,""	   );
		}
		break;
	case(SSSS_EXTEND):	   return set_vflgs(ap,""    ,0,""      ,"x"      ,1,0,"0"	   );
