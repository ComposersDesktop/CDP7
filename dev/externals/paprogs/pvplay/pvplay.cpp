...
//        oneovrsr = 1.0 / (double) props.srate;
        ...
        if(fromdur > 0.0){
            ...
            from_frame = (int)(fromdur * (props.srate/overlap));
    ...
    /* soundfile or anafile*/
        ...
        switch(props.type){
            case wt_analysis:
                ...
                //anal_buflen = (anal_buflen / overlap) * overlap;
                // buflen = anal_buflen;
                from_frame = (int)(fromdur * props.arate);
            ...
            case wt_wave:
                ...
                to_frame = filesize -1;
                if(totime > 0.0){
                    to_frame = (int)(totime * props.srate);
    ...
    if(playtype == PLAY_SFILE && nFramesToPlay <= ringframelen){
        ...
        if(props.srate > 48000)
            ringframelen <<= 1;
        printf("File buffer size set to %d sample frames\n",ringframelen);
